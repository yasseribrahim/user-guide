    ...
    public void showSequence(View view) {
        ...
        new MaterialTapTargetSequence()
                .addPrompt(new MaterialTapTargetPrompt.Builder(MainActivity.this)
                        ...
                        .create())
                .addPrompt(new MaterialTapTargetPrompt.Builder(MainActivity.this)
                        .setTarget(findViewById(R.id.navigation_dashboard))
                        .setPrimaryText("Step 2")
                        .setSecondaryText("This will show till you press it")
                        .setAnimationInterpolator(new LinearOutSlowInInterpolator())
                        .setFocalPadding(R.dimen.dp40)
                        .setIcon(R.drawable.ic_dashboard_black_24dp).create())
                .addPrompt(new MaterialTapTargetPrompt.Builder(MainActivity.this)
                        ...
                        .setIcon(R.drawable.ic_notifications_black_24dp).create())
                .addPrompt(new MaterialTapTargetPrompt.Builder(this)
                        ...
                        .setMaxTextWidth(R.dimen.tap_target_menu_max_width)
                        .setIcon(R.drawable.ic_search)
                        .setTarget(R.id.action_search).create()).showFromIndex(0)
                .show();
    }
